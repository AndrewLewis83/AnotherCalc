#
#  Be sure to run `pod spec lint AnotherCalc.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/AndrewLewis83/AnotherCalc.git", :tag => "#{spec.version}" }
  ...
  spec.source_files = "AnotherCalc/**/*.{swift}"
